                                ...
                                @auth
                                    @if(Auth::user()->utype === 'ADM')
                                        <li className="menu-item menu-item-has-children parent" >
                                            <a title="My Account" href="#">My Account ({{Auth::user()->name}})<i className="fa fa-angle-down" aria-hidden="true"></i></a>
                                    ...
                                    @endif
                                @else
                                    <li className="menu-item" ><a title="Register or Login" href="{{route('login')}}">Login</a></li>
                                    <li className="menu-item" ><a title="Register or Login" href="{{route('register')}}">Register</a></li>
                                @endif
                            @endif
